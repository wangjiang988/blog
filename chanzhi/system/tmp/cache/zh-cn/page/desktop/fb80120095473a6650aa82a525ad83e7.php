...
<div class="clearfix row-main">
                    <script>v.type = "mobile_top";</script>
...
<option value='11' selected='selected'>关于我们</option>
...
<option value='modal'>弹出窗口</option>
</select>
...
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/article/' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self'>当前窗口</option>
<option value='_blank'>新开窗口</option>
