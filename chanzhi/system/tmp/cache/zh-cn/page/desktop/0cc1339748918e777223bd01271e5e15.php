...
<div class="clearfix row-main">
                    <script>v.type = "desktop_top";</script>
...
<option value='2' selected='selected'>推荐空间</option>
</select>
...
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/admin.php?m=index&f=index' placeholder='请输入链接' class='urlInput form-control hide' />
...
<option value='article' selected='selected'>文章类目</option>
<option value='blog'>博客类目</option>
<option value='product'>产品类目</option>
<option value='page'>单页</option>
<option value='custom'>自定义</option>
</select>
<select name='nav[1][article][]' id='nav' class='navSelector form-control '>
<option value='0'>/</option>
<option value='1'>/蝉知下载</option>
<option value='2' selected='selected'>/蝉知动态</option>
<option value='3'>/商业支持</option>
<option value='11'>/知识改进</option>
<option value='12'>/知识改进/一二三</option>
<option value='13'>/知识改进/四五六</option>
...
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='动态' placeholder='请输入标题' class='input-default form-control titleInput' />
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/dynamic.html' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self' selected='selected'>当前窗口</option>
<option value='_blank'>新开窗口</option>
...
<option value='article'>文章类目</option>
<option value='blog'>博客类目</option>
<option value='product' selected='selected'>产品类目</option>
<option value='page'>单页</option>
<option value='custom'>自定义</option>
</select>
<select name='nav[1][article][]' id='nav' class='navSelector form-control hide'>
...
<select name='nav[1][product][]' id='nav' class='navSelector form-control '>
<option value='0' selected='selected'>/</option>
<option value='7'>/蝉知</option>
</select>
<select name='nav[1][page][]' id='nav' class='navSelector form-control hide'>
...
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='产品列表' placeholder='请输入标题' class='input-default form-control titleInput' />
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/product/' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self' selected='selected'>当前窗口</option>
<option value='_blank'>新开窗口</option>
...
<option value='blog'>博客类目</option>
<option value='product'>产品类目</option>
<option value='page' selected='selected'>单页</option>
<option value='custom'>自定义</option>
</select>
<select name='nav[1][article][]' id='nav' class='navSelector form-control hide'>
<option value='0' selected='selected'>/</option>
...
<select name='nav[1][page][]' id='nav' class='navSelector form-control '>
<option value='11'>关于我们</option>
<option value='2' selected='selected'>推荐空间</option>
</select>
<select name='nav[1][blog][]' id='nav' class='navSelector form-control hide'>
...
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='推荐空间' placeholder='请输入标题' class='input-default form-control titleInput' />
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/page/host.html' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self' selected='selected'>当前窗口</option>
<option value='_blank'>新开窗口</option>
...
<option value='company'>关于我们</option>
<option value='contact'>联系我们</option>
<option value='forum' selected='selected'>论坛</option>
<option value='blog'>博客</option>
<option value='book'>手册</option>
<option value='message'>留言</option>
</select>
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='我的博客' placeholder='请输入标题' class='input-default form-control titleInput' />
...
<option value='forum'>论坛</option>
<option value='blog'>博客</option>
<option value='book' selected='selected'>手册</option>
<option value='message'>留言</option>
</select>
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='手册' placeholder='请输入标题' class='input-default form-control titleInput' />
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/admin.php?m=book&f=index' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self' selected='selected'>当前窗口</option>
<option value='_blank'>新开窗口</option>
...
<option value='blog'>博客</option>
<option value='book'>手册</option>
<option value='message' selected='selected'>留言</option>
</select>
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='留言' placeholder='请输入标题' class='input-default form-control titleInput' />
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/admin.php?m=message&f=index' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self' selected='selected'>当前窗口</option>
<option value='_blank'>新开窗口</option>
...
<select name='nav[1][system][]' id='nav' class='navSelector form-control '>
<option value='home'>首页</option>
<option value='company' selected='selected'>关于我们</option>
<option value='contact'>联系我们</option>
<option value='forum'>论坛</option>
<option value='blog'>博客</option>
<option value='book'>手册</option>
...
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='关于我们' placeholder='请输入标题' class='input-default form-control titleInput' />
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/admin.php?m=company&f=index' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self' selected='selected'>当前窗口</option>
<option value='_blank'>新开窗口</option>
