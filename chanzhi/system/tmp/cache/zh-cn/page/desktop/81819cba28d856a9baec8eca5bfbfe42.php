...
<div class="clearfix row-main">
                    <script>v.type = "mobile_bottom";</script>
...
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/company/' placeholder='请输入链接' class='urlInput form-control hide' />
...
<option value='modal' selected='selected'>弹出窗口</option>
</select>
...
<option value='contact' selected='selected'>联系我们</option>
<option value='forum'>论坛</option>
<option value='blog'>博客</option>
<option value='book'>手册</option>
<option value='message'>留言</option>
</select>
<input type='text' name='nav[1][title][]' id='nav[1][title][]' value='联系我们' placeholder='请输入标题' class='input-default form-control titleInput' />
<input type='text' name='nav[1][url][]' id='nav[1][url][]' value='/company-contact.html' placeholder='请输入链接' class='urlInput form-control hide' />
<input type='hidden' name='nav[1][key][]' id='nav[1][key][]' value='' class='input grade1key' />
<select name='nav[1][target][]' id='nav' class='form-control'>
<option value='_self'>当前窗口</option>
<option value='_blank'>新开窗口</option>
